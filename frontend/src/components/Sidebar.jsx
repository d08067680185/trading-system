...
const Icons = {
  ...
  futures:    () => <svg viewBox="0 0 20 20" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"><line x1="5" y1="2" x2="5" y2="18"/><rect x="3" y="6" width="4" height="6" rx="0.5" fill="currentColor" stroke="none"/><line x1="13" y1="2" x2="13" y2="18"/><rect x="11" y="10" width="4" height="6" rx="0.5" fill="currentColor" stroke="none"/></svg>,
...
export default function Sidebar({ page, onNavigate, onSettings, risk, open, onClose }) {
  ...
  const NAV = [
    ...
    { key: 'futures',    label: t('nav_futures'),    Icon: Icons.futures },
